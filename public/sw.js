...
const TILE_CACHE_NAME = "bitacora-tiles-v1";
...
self.addEventListener("fetch", event => {
  ...
  // Map tiles (OpenStreetMap): cache-first so tiles you've already viewed —
  // or pre-downloaded via "Descargar mapa offline" — render with no signal.
